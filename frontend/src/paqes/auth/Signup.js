...
import loginImg from "../../assets/signup1.jpg"
...
const Register=()=>{
    ...
    const registerUser=async(e)=>{
        ...
        if(password.length<6){
            return toast.error("Password must be up to 6 characteer")
        }
       ...
       <section className={`container ${styles.auth}`}>
        ...
        <Card>
           <div className={styles.form}>
                ...
                <button type='submit' className='--btn --btn-primary --btn-block'>Signup</button></form>
